...
<div class="card-custom">
  <form method="POST" action="{{ route('admin.users.update', $user) }}" autocomplete="off">
    ...
    <div class="mb-3">
      <label class="form-label">Nova senha <small class="text-muted">(opcional)</small></label>
    ...
    <div class="d-flex gap-2">
      <button class="btn btn-primary"><i class="fa fa-save me-2"></i>Salvar alterações</button>
